...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        db_frame.grid(row=2, column=0, sticky="ew", padx=20, pady=(14, 0))
        ...
        actions.grid(row=3, column=0, sticky="nsew", padx=20, pady=(14, 0))
        actions.grid_columnconfigure((0, 1), weight=1)
        actions.grid_rowconfigure(1, weight=1)

        # Push
        push_card = ctk.CTkFrame(actions)
        push_card.grid(row=0, column=0, sticky="nsew", padx=(0, 8), pady=(0, 0))
        ...
        pull_card.grid(row=0, column=1, sticky="nsew", padx=(8, 0), pady=(0, 0))
        ...
        log_frame.grid(row=4, column=0, sticky="nsew", padx=20, pady=(14, 18))
