...
export default function Sidebar({ items = [], activeId, onSelect, onLogout, adminEmail, isDark, onToggleTheme, onSearchOpen, showSearch }) {
  return (
    <aside
    ...
    >
      ...
      {/* Search button — shown when on catalogue section */}
      {showSearch && onSearchOpen && (
        <div className="px-2 pb-1">
          <button
            onClick={onSearchOpen}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium w-full transition-opacity hover:opacity-70"
