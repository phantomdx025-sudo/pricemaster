    ...
    <div className="animate-fade-in w-full max-w-sm mx-auto">
      ...
      <div className="text-center mb-10">
        <div
          ...
          style={{ background: 'var(--brand)', boxShadow: '0 4px 20px rgba(124,111,247,0.4)' }}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 60% 40% at 20% 10%, rgba(124,111,247,0.08) 0%, transparent 70%),
            radial-gradient(ellipse 50% 50% at 80% 90%, rgba(124,111,247,0.06) 0%, transparent 70%)
          `,
        }}
      />
      ...
      <p
        ...
        style={{ color: 'var(--text-muted)' }}
      >
        ANKxIOUS · Textile & Garment Supplies
      </p>
    </div>
  )
}